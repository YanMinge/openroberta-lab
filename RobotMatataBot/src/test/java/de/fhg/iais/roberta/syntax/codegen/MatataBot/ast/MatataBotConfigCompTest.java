package de.fhg.iais.roberta.syntax.codegen.MatataBot.ast;
import org.junit.Test;

import de.fhg.iais.roberta.ast.AstTest;
import de.fhg.iais.roberta.util.test.UnitTestHelper;

public class MatataBotConfigCompTest extends AstTest {
    @Test 
    public void MatataBotBrick_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[componentType=MATATABOT,isActor=true,userDefinedName=W,portName=null,componentProperties={}]]]";
        UnitTestHelper.checkConfigAstEquality(testFactory, expectedResult, "/ast/config/robBrick_MatataBot-Brick.xml");
    }

    @Test
    public void MatataBotBrick_astToBlock_XMLtoJAXBtoASTtoXML_ReturnsSameXML() throws Exception {
        UnitTestHelper.checkConfigReverseTransformation(testFactory, "/ast/config/robBrick_MatataBot-Brick.xml");
    }
